...
public class NivelCompletadoN3 extends javax.swing.JDialog {
    private Image imagenFondo;

    public NivelCompletadoN3(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void adjustComponentPositions() {
        ...
        Texto1.setText("⭐⭐⭐ NIVEL 3 COMPLETADO ⭐⭐⭐");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NivelCompletadoN3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NivelCompletadoN3 dialog = new NivelCompletadoN3(new javax.swing.JFrame(), true);
