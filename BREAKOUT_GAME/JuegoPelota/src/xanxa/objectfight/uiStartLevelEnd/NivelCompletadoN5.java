...
public class NivelCompletadoN5 extends javax.swing.JDialog {
    private Image imagenFondo;

    public NivelCompletadoN5(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void adjustComponentPositions() {
        ...
        Texto1.setText("⭐⭐⭐⭐⭐ NIVEL 5 COMPLETADO ⭐⭐⭐⭐⭐");
    ...
    private void initComponents() {
        ...
        BtnNextLevel.setText("GG CAMPEON");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NivelCompletadoN5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NivelCompletadoN5 dialog = new NivelCompletadoN5(new javax.swing.JFrame(), true);
