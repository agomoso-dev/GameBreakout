...
public class NivelCompletadoN2 extends javax.swing.JDialog {
    private Image imagenFondo;

    public NivelCompletadoN2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void adjustComponentPositions() {
        ...
        Texto1.setText("⭐⭐ NIVEL 2 COMPLETADO ⭐⭐");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NivelCompletadoN2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NivelCompletadoN2 dialog = new NivelCompletadoN2(new javax.swing.JFrame(), true);
