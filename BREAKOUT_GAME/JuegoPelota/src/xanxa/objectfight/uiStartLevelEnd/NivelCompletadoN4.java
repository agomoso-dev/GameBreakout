...
public class NivelCompletadoN4 extends javax.swing.JDialog {
    private Image imagenFondo;

    public NivelCompletadoN4(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void adjustComponentPositions() {
        ...
        Texto1.setText("⭐⭐⭐⭐ NIVEL 4 COMPLETADO ⭐⭐⭐⭐");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NivelCompletadoN4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NivelCompletadoN4 dialog = new NivelCompletadoN4(new javax.swing.JFrame(), true);
